    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FQCKappaSkillMatrixScores', models.CharField(max_length=999, verbose_name='FQCKappaSkillMatrixScores')),
                ('FQCKappaSkillMatrixAverageScore', models.FloatField(verbose_name='FQCKappaSkillMatrixAverageScore')),
