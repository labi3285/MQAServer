...
import aws_mqaserver.apis.check_list1
import aws_mqaserver.apis.check_list_item1
...
urlpatterns = [
    ...
    path('upload_check_list1', aws_mqaserver.apis.check_list1.upload_check_list),
